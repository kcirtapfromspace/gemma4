---
experiment: c5-upstream-s26-ultra-cpu
team_tag: c5
backend: litert-lm
device: samsung-s26-ultra
runtime: cpu
...
# c5-upstream-s26-ultra-cpu

<!-- METRICS:BEGIN (auto-generated from duckdb — edits here are overwritten) -->
## Metrics

- **avg_gen_tok_s**: 47.00  •  **p50_gen_tok_s**: 47.00
- **avg_ttft_ms**: 1800  •  **avg_prompt_tok_s**: 557.00
- **extraction_pass_rate**: —
- **avg_extraction_score**: —
- **success_rate (valid JSON)**: —
- **total_runs**: —

> Upstream Google LiteRT-LM benchmark. Peak mem 1733 MB.
...
## Links
- duckdb: `SELECT * FROM experiments WHERE experiment_name = 'c5-upstream-s26-ultra-cpu';`
- per-case: `SELECT * FROM benchmark_runs WHERE experiment_name = 'c5-upstream-s26-ultra-cpu';`
- commit: _TODO_
