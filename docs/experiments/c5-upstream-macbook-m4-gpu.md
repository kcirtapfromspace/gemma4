---
experiment: c5-upstream-macbook-m4-gpu
team_tag: c5
backend: litert-lm
...
# c5-upstream-macbook-m4-gpu

<!-- METRICS:BEGIN (auto-generated from duckdb — edits here are overwritten) -->
## Metrics

- **avg_gen_tok_s**: 160.00  •  **p50_gen_tok_s**: 160.00
- **avg_ttft_ms**: 100  •  **avg_prompt_tok_s**: 7835.00
- **extraction_pass_rate**: —
- **avg_extraction_score**: —
- **success_rate (valid JSON)**: —
- **total_runs**: —

> Upstream Google LiteRT-LM benchmark. Peak mem 1623 MB.
...
## Links
- duckdb: `SELECT * FROM experiments WHERE experiment_name = 'c5-upstream-macbook-m4-gpu';`
- per-case: `SELECT * FROM benchmark_runs WHERE experiment_name = 'c5-upstream-macbook-m4-gpu';`
- commit: _TODO_
