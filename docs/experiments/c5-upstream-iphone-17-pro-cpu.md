---
experiment: c5-upstream-iphone-17-pro-cpu
team_tag: c5
backend: litert-lm
...
# c5-upstream-iphone-17-pro-cpu

<!-- METRICS:BEGIN (auto-generated from duckdb — edits here are overwritten) -->
## Metrics

- **avg_gen_tok_s**: 25.00  •  **p50_gen_tok_s**: 25.00
- **avg_ttft_ms**: 1900  •  **avg_prompt_tok_s**: 532.00
- **extraction_pass_rate**: —
- **avg_extraction_score**: —
- **success_rate (valid JSON)**: —
- **total_runs**: —

> Upstream Google LiteRT-LM benchmark. Peak mem 607 MB.
...
## Links
- duckdb: `SELECT * FROM experiments WHERE experiment_name = 'c5-upstream-iphone-17-pro-cpu';`
- per-case: `SELECT * FROM benchmark_runs WHERE experiment_name = 'c5-upstream-iphone-17-pro-cpu';`
- commit: _TODO_
