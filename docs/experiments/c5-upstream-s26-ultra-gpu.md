---
experiment: c5-upstream-s26-ultra-gpu
team_tag: c5
backend: litert-lm
...
# c5-upstream-s26-ultra-gpu

<!-- METRICS:BEGIN (auto-generated from duckdb — edits here are overwritten) -->
## Metrics

- **avg_gen_tok_s**: 52.00  •  **p50_gen_tok_s**: 52.00
- **avg_ttft_ms**: 300  •  **avg_prompt_tok_s**: 3808.00
- **extraction_pass_rate**: —
- **avg_extraction_score**: —
- **success_rate (valid JSON)**: —
- **total_runs**: —

> Upstream Google LiteRT-LM benchmark. Peak mem 676 MB.
...
## Links
- duckdb: `SELECT * FROM experiments WHERE experiment_name = 'c5-upstream-s26-ultra-gpu';`
- per-case: `SELECT * FROM benchmark_runs WHERE experiment_name = 'c5-upstream-s26-ultra-gpu';`
- commit: _TODO_
