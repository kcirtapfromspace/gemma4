...
enum LookupTable {
    static let snomed: [LookupEntry] = [
        ...
        LookupEntry(code: "27836007",  aliases: ["whooping cough", "pertussis", "coqueluche"]),
        LookupEntry(code: "14189004",  aliases: ["measles", "rubeola", "sarampion", "sarampión"]),
        LookupEntry(code: "36653000",  aliases: ["rubella", "German measles", "three-day measles"]),
        ...
        LookupEntry(code: "56717001",  aliases: ["tuberculosis", "active pulmonary TB", "pulmonary TB", "TB", "lao phoi hoat dong", "lao phoi"]),
        LookupEntry(code: "38362002",  aliases: ["dengue", "dengue fever"]),
        LookupEntry(code: "1857005",   aliases: ["cholera", "choléra"]),
        LookupEntry(code: "240589008", aliases: ["Chlamydia trachomatis infection", "genital chlamydia", "clamidia", "infeccion genital por clamidia"]),
        ...
        LookupEntry(code: "73442001",  aliases: ["Stevens-Johnson syndrome", "Stevens Johnson syndrome", "SJS"]),
        LookupEntry(code: "23067005",  aliases: ["toxic epidermal necrolysis", "Lyell syndrome", "Lyell-syndrome"]),
    ]
    ...
    static let loincs: [LookupEntry] = [
        ...
        LookupEntry(code: "57021-8",  aliases: ["Complete blood count"]),
